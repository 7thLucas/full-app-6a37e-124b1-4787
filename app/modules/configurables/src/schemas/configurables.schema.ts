...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    // ── App Content ────────────────────────────────────────────────────────
    { fieldName: "tagline", type: "string", required: false, label: "App Tagline", maxLength: 200 },
    { fieldName: "welcomeMessage", type: "string", required: false, label: "Welcome Message", maxLength: 300 },
    { fieldName: "chatPlaceholder", type: "string", required: false, label: "Chat Input Placeholder", maxLength: 200 },
    { fieldName: "heroImageUrl", type: "url", required: false, label: "Hero Image URL" },

    // ── Suggested Prompts ──────────────────────────────────────────────────
    {
      fieldName: "suggestedPrompts",
      type: "array",
      required: false,
    ...
    // ── Feature Flags ─────────────────────────────────────────────────────
    { fieldName: "showMapTab", type: "boolean", required: false, label: "Show Map Tab" },
    { fieldName: "showTimelineTab", type: "boolean", required: false, label: "Show Timeline Tab" },
    { fieldName: "maxChatHistoryItems", type: "number", required: false, label: "Max Chat History Items", min: 5, max: 100 },
  ],
};